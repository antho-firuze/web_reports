...
$htmlSatu = '<br></br>
			...
			'.$var->breakline10.'
			<p style="text-align:center"><strong>PT AVRIST ASSET MANAGEMENT</strong><br></br>
			Wisma Metropolitan 1, 9th Floor. Jl.Jend. Sudirman kav 29, Jakarta 12920<br></br>
			Tel +6221 252 1662; Fax : +6221 252 2106, email. CS.AAM@Avrist.com</p>
		<pagebreak>';
...
$htmlDua = '	
			...
			<tr>
				<td valign="top" style="height:auto; font-size:14px;">
					...
					Wisma Metropolitan 1, 9th Floor. Jl.Jend. Sudirman kav 29, Jakarta 12920<br></br>
					Tel +6221 252 1662; Fax : +6221 252 2106, email. CS.AAM@Avrist.com
				</td>
			</tr>
			<tr>
...
$htmlLima = '
			...
			<table border="0" style="border-collapse:collapse; width:100%;">
				...
				<tr>
					<td style="border-left:0; border-top:0; border-right:0; border-bottom:0; text-align:justify; height:20px; font-size:11px; letter-spacing:-0.5px;">
						<strong>Dengan menandatangani formulir ini Saya/Kami menyatakan bahwa semua data yang Saya/Kami isi adalah benar. Saya/Kami telah bertemu dengan marketing officer PT.Avrist Asset Management yang memiliki ijin WAPERD, dan telah membaca dan mengerti isi prospektus dan dengan ini menyatakan terikat pada persyaratan-persyaratan serta ketentuan yang tercantum dalam prospektus, Kontrak Investasi Kolektif, dan formulir ini. Informasi yang diberikan dalam Formulir Pembukaan Rekening Nasabah ini adalah benar dan lengkap. Nasabah akan segera memberitahukan PT Avrist Asset Management dan setiap klaim, gugatan, ganti rugi dan tanggung jawab hukum dalam bentuk apapun yang mungkin timbul apabila terdapat kekeliruan atau kesalahan dalam penanganan rekening nasabah di PT Avrist Asset Management sebagai akibat kelalaian atau kekeliruan nasabah dalam melakukan pengkinian data secara lengkap. Saya mengerti bahwa penggunaan uang tunai atau cek/giro tidak dapat dilakukan untuk investasi ini./</strong>
						<em>By signing this form I / We declare that all the data that I / We have filled in is correct. I / We have met with the marketing officer of PT.Avrist Asset Management who has a WAPERD license, and has read and understood the contents of the prospectus and hereby states that it is bound to the terms and conditions listed in the prospectus, Collective Investment Contract and this form. The information provided in this Customer Account Opening Form is correct and complete. The Customer will immediately notify PT Avrist Asset Management and any claim, lawsuit, compensation and legal liability in any form that may arise if there is a mistake or error in handling customer accounts at PT Avrist Asset Management as a result of negligence or customer error in updating data completely. I understand that the use of cash or checks / demand deposits cannot be made for this investment.</em>
						'.$var->breakline1.'
			...
			<table border="0" style="border-collapse:collapse; width:100%;">
				...
				<tr>
					<td style="border-left:0; border-top:0; border-right:0; border-bottom:0; text-align:justify; height:20px; font-size:11px; letter-spacing:-0.5px;">
						...
						<em>I have made initial verification of all documents and information provided by the customer, including information regarding the existence of the beneficial owner. I am aware that PT Avrist Asset Management has the right to carry out further verification and other supporting documents for information provided by the customer.</em>	
					</td>
				</tr>
				<tr>
			...
			<p style="font-size:10px; text-align:justify; letter-spacing:-0.5px;">
				<strong>PT Avrist Asset Management memiliki hak untuk menolak pembukaan rekening nasabah, dengan pertimbangannya sendiri,tanpa memberikan penjelasan./ </strong>
				<em>PT Avrist Asset Management has the right to refuse opening customer accounts, with its own consideration, without giving an explanation</em>
			</p>
